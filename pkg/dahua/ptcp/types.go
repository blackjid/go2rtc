...
const (
	...
	TypeCommand17 byte = 0x17 // Request sign from relay
	TypeCommand18 byte = 0x18
	TypeCommand19 byte = 0x19 // Authentication
	TypeCommand1A byte = 0x1A // Server response after 0x19
	TypeCommand1B byte = 0x1B // Client response after 0x1A
)
